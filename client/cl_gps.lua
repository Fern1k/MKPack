...
RegisterNetEvent('punch_gps:updateBlip')
AddEventHandler('punch_gps:updateBlip', function(ServerData)	
	local memory = {}
...
RegisterNetEvent("punch_gps:tempBlip")
AddEventHandler("punch_gps:tempBlip", function(playerId, data) 
...
RegisterNetEvent('punch_gps:removeGPSForID')
AddEventHandler('punch_gps:removeGPSForID', function(playerId)
	if blips[playerId] then
		RemoveBlip(blips[playerId])
		blips[playerId] = nil
	end
...
RegisterNetEvent('punch_gps:cleanup')
AddEventHandler('punch_gps:cleanup', function()
	for k,v in pairs(blips) do
		RemoveBlip(v)
		blips[k] = nil
	end
